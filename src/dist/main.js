...
function bootstrap() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document, port, log;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    swagger_1.SwaggerModule.setup('apis', app, document, {
                        swaggerOptions: { persistAuthorization: true }
                    });
                    port = Number((_a = process.env.PORT) !== null && _a !== void 0 ? _a : 4005);
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _b.sent();
                    log = app.get(app_logger_service_1.AppLogger);
                    common_1.Logger.log("Auth service running on http://localhost:" + port, 'Bootstrap');
                    return [2 /*return*/];
            }
        });
    });
