...
var AccessService = /** @class */ (function () {
    function AccessService(prisma) {
        this.prisma = prisma;
    }
    AccessService.prototype.assertCanViewCourse = function (courseId, user) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (course.visibility === client_1.CourseVisibility.ORG_ONLY) {
                            if (!user.tenantId || user.tenantId !== course.organizationUuid) {
                                throw new common_1.ForbiddenException('Not allowed for this organization');
                            }
                            return [2 /*return*/];
                        }
                        if (!(course.visibility === client_1.CourseVisibility.PRIVATE_USERS)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.prisma.courseAllowedUser.findFirst({
    ...
    AccessService.prototype.assertEnrolled = function (courseId, user) {
        return __awaiter(this, void 0, void 0, function () {
            var enr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.enrollment.findUnique({
                            where: { courseId_userUuid: { courseId: courseId, userUuid: user.sub } },
